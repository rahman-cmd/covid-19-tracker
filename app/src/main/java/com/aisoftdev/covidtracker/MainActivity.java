package com.aisoftdev.covidtracker;
...
import com.aisoftdev.covidtracker.api.ApiUtilities;
import com.aisoftdev.covidtracker.api.CountryData;
                    ...
                    public void onResponse(Call<List<CountryData>> call, Response<List<CountryData>> response) {
                        ...
                        for (int i = 0; i<list.size(); i++){
                            if (list.get(i).getCountry().equals(country)){
                                ...
                                todayDeath.setText(NumberFormat.getInstance().format(Integer.parseInt(list.get(i).getDeaths())));
